...
<div class="master-portfolio-account-index">
    ...
    <?= GridView::widget([
        ...
        'filterModel' => $searchModel,
		 'layout'=>'{items}{pager}',
		'tableOptions' => ['id' => 'table-master-bank','class' => 'table table-custom'],
        'columns' => [
...
<script>
	function deleteData(id){
		...
		if(deleted == true){
			url = '<?= Url::base()?>/master-portfolio-account/delete-data?id='+id;
