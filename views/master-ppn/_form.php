    ...
    <div class="panel panel-default mb-3">
        ...
        <div class="panel-body">
            <div style="border: 1px solid #ddd; padding: 15px; border-radius: 4px;">
                ...
                <div id="ppn-details">
                    <?php 
                    if (!$model->isNewRecord && !empty($model->ppnDetails)) {
                        foreach ($model->ppnDetails as $i => $detail) { ?>
                            <div class="ppn-row">
...
$(document).ready(function() {
    ...
    $('#add-row').click(function() {
        var rowCount = $('.ppn-row').length;
        var newRow = $('.ppn-row').first().clone();
    ...
    $(document).on('click', '.remove-row', function() {
        if ($('.ppn-row').length > 1) {
            ...
            $(this).closest('.ppn-row').remove();
            
            // Reindex remaining rows
            $('.ppn-row').each(function(index) {
