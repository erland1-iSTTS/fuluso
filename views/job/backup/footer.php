		...
		<div class="col-md-5">
			<div class="row">
				...
				<div class="col-md-2 pl-1 pr-1">
					<div class="form-group">
						<input type="text" class="form-control" id="currency" placeholder="0" value="<?php if($footer){echo $footer->hbldes_declared_text1;} ?>" name="MasterG3eHblDescription[hbldes_declared_text1]" required>
					</div>
				</div>
				-
				<div class="col-md-1 pl-1" style="flex:0 0 15%;max-width:15%;">
					<div class="form-group">
						<input type="text" class="form-control" id="currency-decimal" placeholder="00" value="<?php if($footer){echo $footer->hbldes_declared_text2;} ?>" name="MasterG3eHblDescription[hbldes_declared_text2]" required>
					</div>
				</div>
			</div>
		</div>
