	...
	?>
		<div id="content">
			<div class="row form-group">
				...
				<div class="col-3">
					<input type="date" class="form-control" id="date_invoice" value="<?= date('Y-m-d') ?>" name="MasterNewJobinvoice[inv_date]" required>
				</div>
			</div>
			...
			<div class="row">
					...
					<div class="row">
						...
						<div class="col-10">
							<div class="form-group">
								<input type="text" class="form-control" id="nama_inv_cust1" value="<?= $nama_customer ?>" readonly>
								<input type="hidden" class="form-control" id="inv_cust1" name="MasterNewJobinvoice[inv_customer]" value="<?= $id_customer ?>">
							</div>
						</div>
						...
						<div class="col-10">
							<div class="form-group">
								<input type="text" class="form-control" id="nama_inv_cust2" value="<?= $customer_alias ?>" readonly>
								<input type="hidden" class="form-control" id="inv_cust2" name="MasterNewJobinvoice[inv_customer2]" value="<?= $id_customer_alias ?>">
							</div>
						</div>
						...
						<div class="col-10">
							<div class="form-group">
								<textarea class="form-control" id="inv_cust3" rows="5" name="MasterNewJobinvoice[inv_customer3]" readonly><?php if(isset($job_party->customer_address)){ echo str_replace("\\n","\n",$job_party->customer_address); }?></textarea>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-6 mb-4">
					<div class="row">
						...
						<div class="col-10">
							<div class="form-group">
								<select class="form-select form-select-lg" id="inv_to1" name="MasterNewJobinvoice[inv_to]" required>
									<option></option>
									<?php
										if(isset($array_to)){
						...
						<div class="col-10">
							<div class="form-group">
								<select class="form-select form-select-lg" id="inv_to2" name="MasterNewJobinvoice[inv_to2]" required>
						...
						<div class="col-10">
							<div class="form-group">
								<textarea class="form-control" id="inv_to3" rows="5" name="MasterNewJobinvoice[inv_to3]" readonly></textarea>
							</div>
						</div>
					</div>
				</div>
						...
						<table class="table" id="table_invoice_idt">
							...
							<tbody>
								<tr>
									...
									<td>
										<input type="text" class="form-control" id="detail-1" value="" name="MasterNewJobinvoiceDetail[detail][1][invd_detail]" required>
									</td>
									<td>
										<div class="row">
											<div class="col-6 pr-1">
												<input type="text" class="form-control basis" id="basis-1" value="" name="MasterNewJobinvoiceDetail[detail][1][invd_basis1_total]" onkeyup="changeBasis(this.id)" required>
											</div>
									...
									<td>
										<input type="text" class="form-control jumlah" id="jumlah-1" value="" name="MasterNewJobinvoiceDetail[detail][1][invd_basis2_total]" onkeyup="changeJumlah(this.id)" required>
									</td>
									<td>
									...
									<td>
										<div class="row">
											<div class="col-7 pr-1">
												...
												<input type="text" class="form-control tarif1" id="tarif1-1" value="" onkeyup="changeTarif(this.id)" required>
											</div>
											<div class="col-5 pl-1 pt-2">
												<input type="text" class="form-control tarif2" id="tarif2-1" style="height:25px" value="00" onkeyup="changeTarif(this.id)">
											</div>	
										</div>
									</td>
									<!-- Subtotal -->
...
<script>
	...
	function addrow(){
		...
		item += '<tr>';
			...
			item += '</td>';
			item += '<td>';
				item += '<input type="text" class="form-control" id="detail-'+i+'" value="" name="MasterNewJobinvoiceDetail[detail]['+i+'][invd_detail]" required>';
			item += '</td>';
			item += '<td>';
				item += '<div class="row">';
					item += '<div class="col-6 pr-1">';
						item += '<input type="text" class="form-control basis" id="basis-'+i+'" value="" name="MasterNewJobinvoiceDetail[detail]['+i+'][invd_basis1_total]" onkeyup="changeBasis(this.id)" required>';
					item += '</div>';
			...
			item += '<td>';
				item += '<input type="text" class="form-control jumlah" id="jumlah-'+i+'" value="" name="MasterNewJobinvoiceDetail[detail]['+i+'][invd_basis2_total]" onkeyup="changeJumlah(this.id)" required>';
			item += '</td>';
			item += '<td>';
			...
			item += '<td>';
				item += '<div class="row">';
					item += '<div class="col-7 pr-1">';
						...
						item += '<input type="text" class="form-control tarif1" id="tarif1-'+i+'" value="" onkeyup="changeTarif(this.id)" required>';
					item += '</div>';
					item += '<div class="col-5 pl-1 pt-2">';
						item += '<input type="text" class="form-control tarif2" id="tarif2-'+i+'" style="height:25px" value="00" onkeyup="changeTarif(this.id)">';
					item += '</div>';	
				item += '</div>';
			item += '</td>';
