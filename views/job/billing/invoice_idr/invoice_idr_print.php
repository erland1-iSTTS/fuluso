...
<div id="print-invoice-idr">
	<div id="header" style="float:left;width:70%;margin-bottom:20px;">
		...
		<div class="title2" style="margin-bottom:2px;">
			...
			Jl. Pegirian 80/I, Surabaya 60145, Indonesia
	...
	<table style="font-size:11px; font-family:Arial, Helvetica, sans-serif">
		...
		<tr>
			...
			<td style="padding-left:7px">Cabang Panglima Sudirman, Surabaya</td>	
		</tr>
		<tr>
			<td></td>
		...
		<tr>
			...
			<td style="padding-left:7px;">
				<div style="width:100%;">
					<span style="letter-spacing:38px">&nbsp;</span> Jl. Pegirian 80-I, Surabaya 60145, ID
				</div>
			</td>	
		</tr>
        <tr>
