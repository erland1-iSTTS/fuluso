...
<input type="hidden" id="invoice_id" value="" name="MasterNewJobinvoice[inv_id]">

	<?php
		Modal::begin([
			'title' => 'Create Invoice IDR',
			'id' => 'modal_invoice_idr',
			'size' => 'modal-xl',
		]);
	?>
		<div id="content">
			<div class="row form-group">
				...
				<div class="col-3">
					<input type="date" class="form-control" id="due_date_invoice_idt" value="<?= date('Y-m-d') ?>" name="MasterNewJobinvoice[inv_due_date]" required>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-6 mb-4">
					<div class="row">
						...
						<div class="col-10">
							<textarea class="form-control" id="additional_notes" rows="4" placeholder="Additional Notes" name="MasterNewJobinvoice[additional_notes]"></textarea>
						</div>
					</div>
				</div>
						...
						<table class="table" id="table_invoice_idt">
							...
							<tbody>
								<tr>
									...
									<!-- Subtotal -->
									<td class="text-right">
										<label class="fw-normal mb-0" id="label_subtotal-1">0.00</label>
								...
								<tr>
									...
									<td class="text-right">
										<!-- Jumlah -->
										<p id="label_total">0.00</p>
										<input type="hidden" class="form-control total" id="total" value="" name="MasterNewJobinvoice[inv_total]">
										
										<!-- PPN -->
										<p class="mb-0" id="label_ppn">0.00</p>
										<input type="hidden" class="form-control totalppn" id="totalppn" value="" name="MasterNewJobinvoice[inv_total_ppn]">
									</td>
									<td>
										<p>IDR</p>
										<p class="mb-0">IDR</p>
