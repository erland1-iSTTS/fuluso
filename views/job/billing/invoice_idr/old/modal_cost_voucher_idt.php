...
<?php $form = ActiveForm::begin(['id' => 'form_invoice_idt', 'action' => Url::base().'/job/save-cost-voucher-idt']); ?>
<input type="hidden" value="<?= $_GET['id']?>" name="MasterNewJobcost[vch_job_id]">
<input type="hidden" id="voucher-invoice-idt" name="MasterNewJobcost[vch_inv_id]">
<?php
	Modal::begin([
...
?>
	<div id="content">
		<div class="row form-group">
			...
			<div class="col-3">
				<input type="date" class="form-control" id="costidt_date" value="<?= date('Y-m-d') ?>" name="MasterNewJobcost[vch_date]" required>
			</div>
        </div>
		...
		<div class="row form-group">
			...
			<div class="col-3">
				<select class="form-control" id="costidt_pay" name="MasterNewJobcost[vch_customer]" required>
				...
				<table class="table" id="table_cost_voucher_idt">
					...
					<tbody>
						<tr>
							...
							<td>
								<select class="form-select form-select-lg" id="costidt_pos-1" name="MasterNewJobcostDetail[detail][1][invd_pos]" required>
									<option value="" disabled hidden></option>
									<?php
										foreach($pos as $row){
											$selected = '';
							...
							<td>
								<input type="text" class="form-control" id="costidt_detail-1" value="" name="MasterNewJobcostDetail[detail][1][invd_detail]" required>
							</td>
							<td>
								<div class="row">
									<div class="col-6 pr-1">
										<input type="text" class="form-control basis" id="costidt_basis-1" value="" name="MasterNewJobcostDetail[detail][1][invd_basis1_total]" onkeyup="changeBasisCostIdt(this.id)" required>
									</div>
									<div class="col-6 pl-1">
										<select class="form-select form-select-lg" id="costidt_basispack-1" name="MasterNewJobcostDetail[detail][1][invd_basis1_type]" required>
											<?php
							...
							<td>
								<input type="text" class="form-control jumlah" id="costidt_jumlah-1" value="" name="MasterNewJobcostDetail[detail][1][invd_basis2_total]" onkeyup="changeJumlahCostIdt(this.id)" required>
							</td>
							<td>
								<select class="form-select form-select-lg" id="costidt_jumlahpack-1" name="MasterNewJobcostDetail[detail][1][invd_basis2_type]" required>
									<?php
										foreach($packages as $row){
											$name = str_replace("'", "&apos;", $row['packages_name']);
							...
							<td>
								<div class="row">
									<div class="col-7 pr-1">
										<input type="hidden" class="form-control costidt_tarif" id="costidt_tarif-1" name="MasterNewJobcostDetail[detail][1][invd_rate]">
										<input type="text" class="form-control costidt_tarif1" id="costidt_tarif1-1" onkeyup="changeTarifCostIdt(this.id)" required>
									</div>
							...
							<td class="text-right">
								...
								<input type="hidden" class="form-control costidt_subtotal" id="costidt_subtotal-1" value="" name="MasterNewJobcostDetail[detail][1][invd_amount]">
							</td>
							<td>IDR</td>
							<td>
								<select class="form-select form-select-lg costidt_ppntype" id="costidt_ppntype-1" name="MasterNewJobcostDetail[detail][1][invd_id_ppn]" required onchange="getTotalCostIdt()">
									<?php
										foreach($ppn as $row){
								...
								<input type="hidden" class="form-control" id="costidt_ppn-1" value="" name="MasterNewJobcostDetail[detail][1][invd_ppn]">
							</td>
						</tr>
						...
						<tr>
							...
							<td class="text-right">
								...
								<input type="hidden" class="form-control costidt_total" id="costidt_total" value="" name="MasterNewJobcost[vch_total]">
								<br>
								<!-- PPN -->
								<label class="fw-normal mt-1 mb-0" id="costidt_label_ppn">0.00</label>
								<input type="hidden" class="form-control costidt_totalppn" id="costidt_totalppn" value="" name="MasterNewJobcost[vch_totalppn]">
							</td>
							<td>
								<p>IDR</p>
								<p>IDR</p>
						...
						<tr>
							...
							<td class="text-right">
								...
								<input type="hidden" class="form-control costidt_grandtotal" id="costidt_grandtotal" value="" name="MasterNewJobcost[vch_grandtotal]">
							</td>
							<td>IDR </td>
							<td></td>
						</tr>
...
<script>
	...
	function addrowCostIdt(){
		...
		item += '<tr>';
			...
			item += '</td>';
			item += '<td>';
				item += '<select class="form-select form-select-lg" id="costidt_pos-'+i+'" name="MasterNewJobcostDetail[detail]['+i+'][invd_pos]" required>';
			...
			item += '</td>';
			item += '<td>';
				item += '<input type="text" class="form-control" id="costidt_detail-'+i+'" value="" name="MasterNewJobcostDetail[detail]['+i+'][invd_detail]" required>';
			item += '</td>';
			item += '<td>';
				item += '<div class="row">';
					item += '<div class="col-6 pr-1">';
						item += '<input type="text" class="form-control costidt_basis" id="costidt_basis-'+i+'" value="" name="MasterNewJobcostDetail[detail]['+i+'][invd_basis1_total]" onkeyup="changeBasisCostIdt(this.id)" required>';
					item += '</div>';
					item += '<div class="col-6 pl-1">';
						item += '<select class="form-select form-select-lg" id="costidt_basispack-'+i+'" name="MasterNewJobcostDetail[detail]['+i+'][invd_basis1_type]" required>';
							item += "<?php
								foreach($packages as $row){
									$name = str_replace("'", "&apos;", $row['packages_name']);
			...
			item += '<td>';
				item += '<input type="text" class="form-control costidt_jumlah" id="costidt_jumlah-'+i+'" value="" name="MasterNewJobcostDetail[detail]['+i+'][invd_basis2_total]" onkeyup="changeJumlahCostIdt(this.id)" required>';
			item += '</td>';
			item += '<td>';
				item += '<select class="form-select form-select-lg" id="costidt_jumlahpack-'+i+'" name="MasterNewJobcostDetail[detail]['+i+'][invd_basis2_type]" required>';
					item += "<?php
						foreach($packages as $row){
							$name = str_replace("'", "&apos;", $row['packages_name']);
			...
			item += '<td>';
				item += '<div class="row">';
					item += '<div class="col-7 pr-1">';
						item += '<input type="hidden" class="form-control costidt_tarif" id="costidt_tarif-'+i+'" name="MasterNewJobcostDetail[detail]['+i+'][invd_rate]">';
						item += '<input type="text" class="form-control costidt_tarif1" id="costidt_tarif1-'+i+'" onkeyup="changeTarifCostIdt(this.id)" required>';
					item += '</div>';
			...
			item += '<td class="text-right">';
				...
				item += '<input type="hidden" class="form-control costidt_subtotal" id="costidt_subtotal-'+i+'" value="" name="MasterNewJobcostDetail[detail]['+i+'][invd_amount]">';
			item += '</td>';
			item += '<td>IDR</td>';
			
			item += '<td>';
				item += '<select class="form-select form-select-lg costidt_ppntype" id="costidt_ppntype-'+i+'" name="MasterNewJobcostDetail[detail]['+i+'][invd_id_ppn]" onchange="getTotalCostIdt()" required>';
					item += "<?php
						foreach($ppn as $row){
							$name = explode('-', $row['name']);
							$name_ppn = $name[1].'-'.$row['amount'].'%';
					...
					?>";
				item += '</select>';
				item += '<input type="hidden" class="form-control" id="costidt_ppn-'+i+'" value="" name="MasterNewJobcostDetail[detail]['+i+'][invd_ppn]">';
			item += '</td>';
		item += '</tr>';
