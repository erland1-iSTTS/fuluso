...
<div class="draft-bl-index">
	...
	<div class="w-100">
		...
		<div style="float:right;width:50%">
			...
			<div style="height:93px;">
				<div class="arial" style="font-size:37px;letter-spacing:1px">&nbsp;</div>
				
				<div style="float:left;width:55%;padding-top:5px">
					<div class="couriers" style="font-size:14px;">
						<span style="background-color:yellow;letter-spacing:1px;">CARGO RECEIPT</span><br/>
						<span style="letter-spacing:1px;">&nbsp;</span>
					</div>
				</div>
				
				<div style="float:right;width:44%;padding-top:22px">
					<div class="label-header">
						BILL OF LADING NO.
					</div>
	...
	<div>
		<div style="float:left;width:4.2%;padding-top:5px;padding-left:7px">
			<!--<img src="<?php //Url::base().'/img/nn.jpg'?>" width="25px" height="220px">-->
		</div>
