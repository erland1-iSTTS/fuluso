...
<div class="draft-bl-index">
	<div class="w-100">
		<!-- HEADER -->
		<div class="title-draft" style="float:left; width:60%; text-align:left;"></div>
	...
	<div class="m-0">
		<div class="w-100" style="">
			<div style="float:left; width: 5.5%; padding-top:7px;">
				<!--<img src="<?php //Url::base().'/img/nn.jpg'?>" width="35px">-->
			</div>
		...
		<div style="border-top:1px solid black;margin-left:35px;padding-top:5px" class="font2">
			<?php
				if(isset($ori_batch)){
					if(!empty($ori_batch['batchform_1'])){
						$ori_batch1 = $ori_batch['batchform_1'];
					}else{
						$ori_batch1 = '';
					}
					if(!empty($ori_batch['batchform_2'])){
						$ori_batch2 = $ori_batch['batchform_2'];
					}else{
						$ori_batch2 = '';
					}
					if(!empty($ori_batch['batchform_3'])){
						$ori_batch3 = $ori_batch['batchform_3'];
					}else{
						$ori_batch3 = '';
					}
					
					echo 'BATCH# '.$ori_batch1.' / '.$ori_batch2.' / '.$ori_batch3;
				}
			?>
		</div>
	</div>
