		...
		<div class="ml-auto" style="margin-right:35px">
			...
			<?php }elseif($jobinfo->step == 3){ ?>
				<div class="row on-progress">
					...
					<a href="<?= Url::base().'/job/approve-original-bl?id='.$_GET['id'] ?>" class="btn btn-clear btn-xs" id="origin-on-progress" style="border:none">Original BL : On Request</a>
				</div>
			...
			<?php }elseif($jobinfo->step == 5){ ?>
				<div class="row views">
					...
					<a href="<?= Url::base().'/job/approve-express-release?id='.$_GET['id'] ?>" class="btn btn-clear btn-xs" id="erc-on-process" style="border:none">Express Release : On Process</a>
				</div>
			...
			<?php }elseif($jobinfo->step == 7){ ?>
				<div class="row views">
					...
					<a href="<?= Url::base().'/job/approve-seaway-bill?id='.$_GET['id'] ?>" class="btn btn-clear btn-xs" id="swb-on-process" style="border:none">Seaway Bill : On Process</a>
				</div>
			...
			<?php }elseif($jobinfo->step == 9){ ?>
				<div class="row views">
					...
					<a href="<?= Url::base().'/job/approve-cargo-receipt?id='.$_GET['id'] ?>" class="btn btn-clear btn-xs" id="cr-on-process" style="border:none">Cargo Receipt : On Process</a>
				</div>
