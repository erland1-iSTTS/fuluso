		...
		<div style="width:50%;">
			<div class="row m-0">
				...
				<div class="col-6 pl-0">
					<input type="text" class="form-control" id="payable-details" name="MasterG3eHblDescription[hbldes_payable_details]" value="<?php if($freight_terms){echo $freight_terms->hbldes_payable_details;} ?>" required>
				</div>
			</div>
		</div>
		...
		<div style="width:50%;margin-left:20px">
			<div class="row">
				<div class="form-check ml-4">
					<input type="checkbox" class="form-check-input" id="payable_status" name="MasterG3eHblDescription[hbldes_payable_status]" value="1" <?php if($freight_terms){if($freight_terms->hbldes_payable_status == 1){echo 'checked';}} ?>>
				</div>
				<div class="col-2 pl-1">
					<label class="fw-normal" for="payable_status">Payable At</label>
				</div>
				<div class="col-5">
					<div class="form-group">
