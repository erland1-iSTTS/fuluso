...
<div class="accordion" id="panel_job">
	<div class="card">
		<div class="card-header" id="heading7">
			<div class="row pl-2 pr-2">
				<h2 class="uncomplete m-0" style="width:92%" data-toggle="collapse" data-target="#collapse7">
					<button class="btn btn-menu" type="button" data-toggle="collapse" data-target="#collapse7">
						Counter Party
					</button>
				</h2>
				<div class="uncomplete pr-3" style="width:8%">
					<button type="button" class="btn btn-dark float-right">Save</button>
				</div>
			</div>
		</div>
		
		<div id="collapse7" class="collapse" data-parent="#panel_job">
			<div class="card-body p-3">
				<?= $this->render('party-counter') ?>
			</div>
		</div>
	</div>
	...
	<div class="card">
		<div class="card-header" id="heading0">
			<div class="row pl-2 pr-2">
				<h2 class="uncomplete m-0" style="width:92%" data-toggle="collapse" data-target="#collapse0">
					<button class="btn btn-menu" type="button" data-toggle="collapse" data-target="#collapse0">
						Parties
					</button>
				</h2>
				<div class="uncomplete pr-3" style="width:8%">
					<button type="button" class="btn btn-dark float-right" id="btn_save_parties">Save</button>
				</div>
			</div>
		</div>
		
		<div id="collapse0" class="collapse" data-parent="#panel_job">
			<div class="card-body p-3">
				<?= $this->render('parties', ['parties' => $parties,]) ?>
			</div>
		</div>
	</div>
