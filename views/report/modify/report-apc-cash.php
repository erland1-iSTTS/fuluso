	...
	<div class="row">
		<div class="col-12">
			<div class="float-left">
				<a href="<?= Url::base().'/report/report-apc-cash'?>" type="button" class="btn btn-dark">Back<a>
			</div>
			<div class="text-center">
				<h5><b>MODIFY ALIAS REPORT AP-C CASH</b></h5>
			</div>
		</div>
	</div>
...
<script>
	...
	function updateCount(vch_id, vch_count_alias){
		...
		$('#report_link').val('report-apc-cash-alias');
