	...
	<div class="row">
		<div class="col-12">
			<div class="float-left">
				<a href="<?= Url::base().'/report/report-apc-fixed'?>" type="button" class="btn btn-dark">Back<a>
			</div>
			<div class="text-center">
				<h5><b>MODIFY ALIAS REPORT AP-C FIXED</b></h5>
			</div>
		</div>
	</div>
	...
	<table class="table table-bordered" style="font-size:12px">
		<tr>
			<td colspan="5" style="background-color:#2f2f2f; color:#fff; text-align:left">
				<div style="display:inline-block; margin-left:15px; font-size:20px; margin-right:100px">LAPORAN AP-C FIXED</div>
...
<script>
	...
	function updateCount(vch_id, vch_count_alias){
		...
		$('#report_link').val('report-apc-fixed-alias');
