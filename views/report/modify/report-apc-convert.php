...
<div class="report-cash" style="font-size:12px">
	<div class="row">
		<div class="col-12">
			<div class="float-left">
				<a href="<?= Url::base().'/report/report-apc-convert'?>" type="button" class="btn btn-dark">Back<a>
			</div>
			<div class="text-center">
				<h5><b>MODIFY ALIAS REPORT AP-C CONVERT</b></h5>
			</div>
		</div>
	</div>
	...
	<table class="table table-bordered" style="font-size:12px">
		...
		<tr>
			...
			<td colspan="3" style="background-color:#2f2f2f;vertical-align:middle; color:#fff" class="text-center" width="60%">APC/BKM No.</td>
...
<script>
	...
	function updateCount(vch_id, vch_count_alias){
		...
		$('#report_link').val('report-apc-convert-alias');
