...
<div class="report-bank" style="font-size:12px">
	<div class="row">
		<div class="col-12">
			<div class="float-left">
				<a href="<?= Url::base().'/report/report-apb'?>" type="button" class="btn btn-dark">Back<a>
			</div>
			<div class="text-center">
				<h5><b>MODIFY ALIAS REPORT AP-B</b></h5>
			</div>
		</div>
	</div>
	...
	<table class="table table-bordered" style="font-size:12px">
		...
		<tr>
			<!-- BBK -->
			<td style="background-color:#2f2f2f; color:#fff" class="text-center" width="20%">APB/BBK No. (BNI)</td>
			...
			<td style="background-color:#2f2f2f; color:#fff" class="text-center" width="20%">APB/BBK No. (PERMATA)</td>
			<td style="background-color:#2f2f2f; color:#fff" class="text-center" width="15%">TANGGAL</td>
			<td style="background-color:#2f2f2f; color:#fff" class="text-center" width="15%">JUMLAH</td>
		</tr>
...
<script>
	...
	function updateCount(vch_id, vch_count_alias){
		...
		$('#report_link').val('report-apb-alias');
