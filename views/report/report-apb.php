...
<div class="report-bank" style="font-size:12px">
	...
	<div class="tab mb-3">
		<ul class="nav nav-pills">
			<li class="nav-item">
				<a class="nav-link" href="<?= Url::base() ?>/report/report-arb">AR-B</a>
			</li>
			<li class="nav-item">
				<a class="nav-link active" href="#">AP-B</a>
			</li>
		</ul>
	</div>
	...
	<div class="row">
		...
		<div class="col-2">
			<button type="button" id="filter_search" onclick="searchApb()" class="btn btn-default mr-1">FILTER</button>
			<button type="button" id="filter_clear" onclick="clearApb()" class="btn btn-default mr-4">RESET</button>
		</div>
		...
		<div class="col-2">
			<button type="button" id="filter_clear" onclick="modifyApb()" class="btn btn-default mr-4">MODIFY</button>
		</div>
		
		<div class="col-2 text-right">
			<button type="button" id="btn_print" onclick="printApb()" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i>&emsp;PDF</button>
		</div>
	</div>
	...
	<table class="table table-bordered" style="font-size:12px">
		<tr>
			<td colspan="9" style="background-color:#2f2f2f; color:#fff; text-align:left">
				<div style="display:inline-block; margin-left:15px; font-size:20px; margin-right:100px">LAPORAN AP-B</div>
		...
		<tr>
			...
			<!-- BBK -->
			<td style="background-color:#2f2f2f; color:#fff" class="text-center" width="15%">APB/BBK No. (BNI)</td>
			...
			<td style="background-color:#2f2f2f; color:#fff" class="text-center" width="15%">APB/BBK No. (PERMATA)</td>
			<td style="background-color:#2f2f2f; color:#fff" class="text-center" width="8%">TANGGAL</td>
			<td style="background-color:#2f2f2f; color:#fff" class="text-center" width="10%">JUMLAH</td>
		</tr>
		...
		<tr>
			...
			<td align="center" colspan="2">TOTAL APB / BBK (BNI)</td>
			<td align="right">
				<b><?= number_format($total_ap1,0,'.',',') ?></b>
			</td>
			<td align="center" colspan="2">TOTAL APB / BBK (PERMATA)</td>
			<td align="right">
...
<script>
	...
	function searchApb(){
		...
		url = '<?= Url::base()?>/report/report-apb?month='+month+'&year='+year;
		window.location.replace(url);
	}
	
	function clearApb(){
		url = '<?= Url::base()?>/report/report-apb';
		window.location.replace(url);
	}
	...
	function modifyApb(){
		...
		url = '<?= Url::base()?>/report/report-apb-alias?date='+date;
		window.location.replace(url);
	}
