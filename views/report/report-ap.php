...
<div class="report-ap" style="font-size:12px">
	...
	<div class="row">
		...
		<button type="button" id="filter_ar_clear" onclick="clearAp()" class="btn btn-default mr-4">RESET</button>
	</div>
...
<script>
	...
	function searchAp(){
		...
		url = '<?= Url::base()?>/report/report-ap?month='+month+'&year='+year;
		window.location.replace(url);
	}
	
	function clearAp(){
		url = '<?= Url::base()?>/report/report-ap';
		window.location.replace(url);
	}
</script>
