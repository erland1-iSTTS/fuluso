...
<div class="master-profile-index">
            ...
            [
				...
				'buttons'=>[
					'view'=>function($url, $model){
						...
						return Html::a($icon, ['view', 'id'=>$model->customer_id], [
							'title' => 'view',
					...
					'update'=>function($url, $model){
						...
						return Html::a($icon, ['master-profile/edit-customer', 'id'=>$model->customer_id], [
							'title' => 'Update',
							'style' => 'padding:0px 2px',
						]);
					},
					'delete'=>function($url, $model){
						...
						return Html::a($icon, ['delete', 'id'=>$model->customer_id], [
							'title' => 'Delete',
							'style' => 'padding:0px 2px',
						]);
					},
