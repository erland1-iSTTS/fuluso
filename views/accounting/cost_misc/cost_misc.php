...
$list_cost 	= MasterNewCostmisc::find()->where(['vch_is_active'=>1])->orderBy(['vch_count'=>SORT_DESC])->all();
?>
	...
	<div class="row">
				...
				?>
					<tr>
						<td style="text-align:left;">
							<a href="<?= Url::base() ?>/job/print-cost-misc?id_cost=<?= $row['vch_id'] ?>" style="color:black;text-decoration:none" target="_blank">
		...
		<div class="col-4">
			...
			<div class="row m-0" style="border:1px solid lightgray;font-size:25px;padding:10px">
				...
				<div class="col-6 text-right"><?= $total_all ?></div>
			</div>
...
?>
	<?php $form = ActiveForm::begin([
		...
		<div class="row">
			...
			<div class="col-9">
				<div class="form-check form-check-inline col-md-4">
					...
					<label class="form-check-label" for="vch_mode1">AP-C-MISC</label>
				</div>
				<div class="form-check form-check-inline col-md-5">
					...
					<label class="form-check-label" for="vch_mode2">AP-B-MISC</label>
				</div>
			</div>
		</div>
		...
		<div class="row mt-3 mb-3" id="div_bkk_type">
			<label class="col-2"></label>
			<div class="col-9">
...
?>
	<?php $form = ActiveForm::begin([
		...
		<div class="row">
			...
			<div class="col-9">
				<div class="form-check form-check-inline col-md-4">
					...
					<label class="form-check-label" for="edit_vch_mode1">AP-C-MISC</label>
				</div>
				<div class="form-check form-check-inline col-md-5">
					...
					<label class="form-check-label" for="edit_vch_mode2">AP-B-MISC</label>
				</div>
			</div>
		</div>
		...
		<div class="row mt-3 mb-3" id="edit_div_bkk_type">
			<label class="col-2"></label>
			<div class="col-9">
				<label id="label_mode_type">BKK Type :</label>
				<div class="form-check form-check-inline col-md-12">
...
<script>
	...
	function searchAp(){
		...
		url = '<?= Url::base()?>/accounting/cost-misc?month='+month+'&year='+year;
		window.location.replace(url);
	}
	
	function clearAp(){
		url = '<?= Url::base()?>/accounting/cost-misc';
		window.location.replace(url);
	}
