...
<div class="accordion" id="panel_accounting">
		...
		<div class="card-header" id="heading1">
			<div class="row pl-2 pr-2">
				<div class="col-6 pl-0">
					<h2 class="uncomplete m-0" style="width:100%;background-color:#eee" data-toggle="collapse">
						<button class="btn btn-menu" type="button" onclick="window.location='<?= Url::base().'/accounting/ar'?>'">
							AR JOB
						</button>
					</h2>
				</div>
				<div class="col-6 pr-0">
					<h2 class="uncomplete m-0" style="width:100%;background-color:#eee" data-toggle="collapse">
						<button class="btn btn-menu" onclick="window.location='<?= Url::base().'/accounting/ap'?>'">
							AP JOB
						</button>
					</h2>
				</div>
	...
	<!--<div class="card">
		...
		<div id="collapse_acc2" class="collapse" data-parent="#panel_accounting">
			<div class="card-body p-3">
				<?php //$this->render('list_ap_payment', []) ?>
			</div>
		</div>
	</div>-->
	...
	<div class="card">
		<div class="card-header" id="heading4">
			<div class="row pl-2 pr-2">
				<div class="col-6 pl-0">
					<h2 class="uncomplete m-0" style="width:100%;background-color:#eee" data-toggle="collapse">
						<button class="btn btn-menu" onclick="window.location='<?= Url::base().'/accounting/cost-opr'?>'">
							COST OPERATIONAL
						</button>
					</h2>
				</div>
				<div class="col-6 pr-0">
					<h2 class="uncomplete m-0" style="width:100%;background-color:#eee" data-toggle="collapse">
						<button class="btn btn-menu" onclick="window.location='<?= Url::base().'/accounting/cost-misc'?>'">
							COST MISC
						</button>
					</h2>
				</div>
		...
		<div class="card-header" id="heading3">
			<div class="row pl-2 pr-2">
				<h2 class="uncomplete m-0" style="width:100%;background-color:#eee" data-toggle="collapse" data-target="#collapse_acc3">
					<button class="btn btn-menu" type="button" onclick="window.location='<?= Url::base().'/accounting/cost-operational'?>'">
						COST OPERATIONAL IDR
					</button>
				</h2>
			</div>
		</div>
	...
	<!--<div class="card">
		<div style="height:35px;background-color:gray">
		</div>
	</div>
	...
	<div class="card">
		<div class="card-header" id="heading1">
			<div class="row pl-2 pr-2">
				<h2 class="uncomplete m-0" style="width:100%;background-color:#eee" data-toggle="collapse" data-target="#collapse_acc10">
					<button class="btn btn-menu" type="button" data-toggle="collapse" data-target="#collapse_acc1">
						AR IDT
					</button>
				</h2>
			</div>
		...
		<div id="collapse_acc1" class="collapse" data-parent="#panel_accounting">
			<div class="card-body p-3">
				<?php //$this->render('ar_receipt_list', []) ?>
				<?php //$this->render('ar_receipt_create', []) ?>
			</div>
		</div>
	</div>
	...
	<div class="card" style="display:<?php //$visible_maker ?>">
		...
		<div id="collapse_create_ap" class="collapse" data-parent="#panel_accounting">
			<div class="card-body p-3">
				<?php //$this->render('list_ap_opr') ?>
				<?php //$this->render('create_ap_opr') ?>
			</div>
		</div>
	</div>
	
	<div class="card" style="display:<?php //$visible_approver ?>">
		<div class="card-header" id="heading">
			<div class="row pl-2 pr-2">
		...
		<div id="collapse_input_ap_opr" class="collapse" data-parent="#panel_accounting">
			<div class="card-body p-3">
				<?php //$this->render('list_ap_opr_voucher') ?>
			</div>
		</div>
	</div>
