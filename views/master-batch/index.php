...
<div class="batch-index">
    ...
    <p>
        <?= Html::a('ADD', ['add'], ['class' => 'btn btn-dark']) ?>
        <?php //Html::a('ADD 2', ['add2'], ['class' => 'btn btn-dark']) ?>
    </p>
        ...
        'columns' => [
			...
			[
				...
				'value' => function ($model){
                    return 'BT'.sprintf('%08d', $model->batch_id);
                },
			],
			[
				'attribute' => 'pol_id',
				...
				'value' => function ($model){
                    return $model->pol_id.'/'.$model->pc_vessel.'/'.$model->pc_voyage.'/'.$model->pol_dod;
                },
			],
			[
				'attribute' => 'lfp_id',
				...
				'contentOptions'=>['style' => 'width:35%'],
				'value' => function ($model){
                    return $model->lfp_id.'/'.$model->pc_vessel.'/'.$model->pc_voyage.'/'.$model->lfp_dod;
                },
			],
            [
				...
				'buttons'=>[
					'view'=>function($url, $model){
						...
						return Html::a($icon, ['view', 'id'=>$model->batch_id], [
							'title' => 'view',
					...
					'delete'=>function($url, $model){
						...
						return Html::a($icon, ['delete', 'id'=>$model->batch_id], [
							'title' => 'Delete',
							'style' => 'padding:0px 2px',
						]);
					},
