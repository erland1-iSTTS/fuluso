...
<?php
//Cost
$cost = MasterNewCostopr::find()->where(['vch_id'=>$id_cost])->one();
$cost_detail = MasterNewCostoprDetail::find()->where(['vchd_vch_id'=>$id_cost])->orderBy(['vchd_id'=>SORT_ASC])->asArray()->all();
