...
<input type="hidden" id="cost_id" value="" name="MasterNewCostopr[vch_id]">
			...
			<div class="row form-group">
				<div class="col-6">
					<div class="row">
						...
						<div class="col-7">
							<input type="date" class="form-control" id="vch_date_idr" value="<?= date('Y-m-d') ?>" name="MasterNewCostopr[vch_date]" required>
						</div>
					</div>
				</div>
				...
				<div class="col-6">
					<div class="row">
						...
						<div class="col-7">
							<input type="date" class="form-control" id="vch_due_date_idr" value="<?= date('Y-m-d') ?>" name="MasterNewCostopr[vch_due_date]" required>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-6 mb-4">
					<div class="row">
						...
						<div class="col-7">
							<input type="text" class="form-control" id="vch_pay_to_idr" name="MasterNewCostopr[vch_pay_to]" required>
						</div>
					</div>
				</div>
				...
				<div class="col-6">
					<div class="row">
						...
						<div class="col-7">
							<select class="form-select form-select-lg" id="vch_pay_for_idr" name="MasterNewCostopr[office_id]" required>
								<option></option>
								<?php
						...
						<table class="table" id="table_cost_opr">
							...
							<tbody>
								<tr>
									...
									<td>
										<select class="form-select form-select-lg" id="cost_pos-1" name="MasterNewCostoprDetail[detail][1][vchd_pos]" required>
									...
									<td>
										<input type="text" class="form-control" id="cost_detail-1" value="" name="MasterNewCostoprDetail[detail][1][vchd_detail]">
									</td>
									<td>
										<input type="text" class="form-control cost_jumlah" id="cost_jumlah-1" value="" name="MasterNewCostoprDetail[detail][1][qty]" onkeyup="changeInputCost(this.id)" required>
									</td>
									<td>
										<select class="form-select form-select-lg" id="cost_jumlahpack-1" name="MasterNewCostoprDetail[detail][1][vchd_unit_type]" required>
											<?php
									...
									<td>
										<div class="row">
											<div class="col-7 pr-1">
												<input type="hidden" class="form-control cost_tarif" id="cost_tarif-1" value="" name="MasterNewCostoprDetail[detail][1][vchd_rate]">
									...
									<td class="text-right">
										...
										<input type="hidden" class="form-control cost_subtotal" id="cost_subtotal-1" value="" name="MasterNewCostoprDetail[detail][1][vchd_amount]">
									</td>
									<td>IDR</td>
									<td>
										<select class="form-select form-select-lg cost_ppntype" id="cost_ppntype-1" name="MasterNewCostoprDetail[detail][1][vchd_id_ppn]" onchange="getTotalCost()" required>
										...
										<input type="hidden" class="form-control cost_ppn" id="cost_ppn-1" value="" name="MasterNewCostoprDetail[detail][1][vchd_ppn]">
									</td>
								</tr>
								...
								<tr>
									...
									<td class="text-right">
										...
										<input type="hidden" class="form-control cost_total" id="cost_total" value="" name="MasterNewCostopr[vch_total]">
										
										<!-- PPN -->
										<p class="mb-0" id="cost_label_ppn">0.00</p>
										<input type="hidden" class="form-control cost_totalppn" id="cost_totalppn" value="" name="MasterNewCostopr[vch_total_ppn]">
									</td>
									<td>
										<p>IDR</p>
										<p class="mb-0">IDR</p>
								...
								<tr>
									...
									<td class="text-right">
										...
										<input type="hidden" class="form-control cost_grandtotal" id="cost_grandtotal" value="" name="MasterNewCostopr[vch_grandtotal]">
									</td>
									<td>IDR</td>
									<td></td>
								</tr>
...
<script>
	...
	function addrow_cost_opr(){
		...
		item += '<tr>';
			...
			item += '</td>';
			item += '<td>';
				item += '<select class="form-select form-select-lg" id="cost_pos-'+i+'" name="MasterNewCostoprDetail[detail]['+i+'][vchd_pos]" required>';
			...
			item += '</td>';
			item += '<td>';
				item += '<input type="text" class="form-control" id="cost_detail-'+i+'" value="" name="MasterNewCostoprDetail[detail]['+i+'][vchd_detail]">';
			item += '</td>';
			
			item += '<td>';
				item += '<input type="text" class="form-control cost_jumlah" id="cost_jumlah-'+i+'" value="" name="MasterNewCostoprDetail[detail]['+i+'][qty]" onkeyup="changeInputCost(this.id)" required>';
			item += '</td>';
			item += '<td>';
				item += '<select class="form-select form-select-lg" id="cost_jumlahpack-'+i+'" name="MasterNewCostoprDetail[detail]['+i+'][vchd_unit_type]" required>';
					item += "<?php
						foreach($packages as $row){
							$name = str_replace("'", "&apos;", $row['packages_name']);
			...
			item += '<td>';
				item += '<div class="row">';
					item += '<div class="col-7 pr-1">';
						item += '<input type="hidden" class="form-control cost_tarif" id="cost_tarif-'+i+'" value="" name="MasterNewCostoprDetail[detail]['+i+'][vchd_rate]">';
			...
			item += '<td class="text-right">';
				...
				item += '<input type="hidden" class="form-control cost_subtotal" id="cost_subtotal-'+i+'" value="" name="MasterNewCostoprDetail[detail]['+i+'][vchd_amount]">';
			item += '</td>';
			item += '<td>IDR</td>';
			
			item += '<td>';
				item += '<select class="form-select form-select-lg cost_ppntype" id="cost_ppntype-'+i+'" name="MasterNewCostoprDetail[detail]['+i+'][vchd_id_ppn]" onchange="getTotalCost()" required>';
					...
					?>";
				item += '</select>';
				item += '<input type="hidden" class="form-control cost_ppn" id="cost_ppn-'+i+'" value="" name="MasterNewCostoprDetail[detail]['+i+'][vchd_ppn]">';
			item += '</td>';
		item += '</tr>';
