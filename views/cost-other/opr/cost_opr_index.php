	...
	<div class="row">
		<div class="col-12">
			<table class="table" id="table-cost-idt" style="font-size:12px">
				...
				<tbody>
					<?php
						$cost_opr = MasterNewJobcost::find()->where(['vch_currency' => 'IDR', 'vch_type' => 3])->orderBy(['vch_count'=>SORT_DESC])->all();
						$i = 0;
						...
						$office = Office::find()->where(['office_code' => $row['vch_office_id']])->one();
					?>
						<tr>
