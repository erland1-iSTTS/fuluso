...
<div class="master-hak-akses-index">
    <h1><?= Html::encode($this->title) ?></h1>

    <div class="row form-group">
		<div class="col-12">
			<a href="<?= Url::base()?>/master-hak-akses/create" type="button" class="btn btn-dark">ADD NEW</a>
		</div>
	</div>
    ...
    <?= GridView::widget([
		...
		'layout'=>'{items}{pager}',
		'tableOptions' => ['id' => 'table-master-user','class' => 'table table-custom'],
        'columns' => [
