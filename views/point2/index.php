...
<div class="point-index">
	...
	<div class="master-point-form" style="margin:20px 0px">
		<p>Data Source : <a href="https://unece.org/trade/cefact/unlocode-code-list-country-and-territory">https://unece.org/trade/cefact/unlocode-code-list-country-and-territory</a></p>
		<p>Data Updated : 2024-02-01 00:00:00</p>
		<p><span class="badge bg-success" style="color:white; padding:5px;">Monthly Auto-Update is ON</span></p>

		<!--<select class="form-control" style="width:30%" id="vessel-0">
			<?php
				foreach($countrycode as $row){
					if($row['code'] == 'ID'){
						echo "<option value='".$row['code']."' selected>".$row['name']."</option>";
					}elseif($row['code'] == 'CA' || $row['code'] == 'US' || $row['code'] == 'UM'){
			...
			<?php
				foreach($countrycode as $row){
					if($row['name'] !== 'ID' || $row['code'] !== 'CA' || $row['code'] !== 'US' || $row['code'] !== 'UM'){
						echo "<option value='".$row['code']."'>".$row['name']."</option>";
					}
				}
			?>
